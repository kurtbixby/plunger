...
function StatusTableRowExpanded(props) {
    ...
    const { state: {isLoggedIn, user: currentUser} } = useCurrentUser();
    ...
    async function submitForm(e) {
        ...
        if (isLoggedIn) {
            await APICalls.sendEditGameStatusRequest(currentUser.id, gameStatus.game.id, statusEdits);
        }
    }
    ...
    return <div className="mx-2">
        <div className="border border-solid border-slate-600 border-t-0 bg-fuchsia-400 rounded-b-md">
            ...
            {hasCollection && <div className="flex place-content-center">
