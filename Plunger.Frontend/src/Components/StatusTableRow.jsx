...
function StatusTableRow(props) {
  ...
  return (
    <div key={gameStatus.id} className={isExpanded ? " mb-1" : ""}>
      <div
        className={
          "border border-solid border-slate-600 flex justify-center text-center bg-amber-200"
        }
      ...
      >
        ...
        <p className={"basis-1/12"}>
          {gameStatus.dateCompleted
            ? dateFormat(gameStatus.dateCompleted)
            : "N/A"}
        </p>
      </div>
