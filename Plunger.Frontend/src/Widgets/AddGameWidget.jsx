...
function AddGameWidget() {
  ...
  useEffect(() => {
    (async () => {
      ...
      const searchResponse = await APICalls.sendGameSearchRequest(
    ...
    <div className="bg-purple-500">
      ...
      <form onSubmit={submitAddGame}>
        <div>
          ...
          <div>
            <SearchDropDown
              onTextChange={changeTextDispatch}
              onItemSelect={selectGameDispatch}
        ...
        <div>
          ...
          <div>
            ...
            <WrappedSelect
              name={"platform"}
              contents={formState.game?.platforms ?? platforms}
              value={formState.platformId}
              onSelect={(e) => selectPlatformIdDispatch(e.target.value)}
            />
          </div>
        </div>
        {/*<div>*/}
        ...
        <div>
          ...
          <WrappedSelect
            name={"region"}
            contents={formState.game?.regions ?? []}
            value={formState.region}
            onSelect={(e) => selectRegionDispatch(e.target.value)}
          />
          {/*<input*/}
          {/*    name="region"*/}
          {/*    type="text"*/}
        ...
        <div>
          <input
            ...
            name="tangibility"
            value="physical"
            checked={formState.tangibility === "physical"}
            onChange={(e) => selectTangibilityDispatch(e.target.value)}
          />
        ...
        <div>
          <input
            ...
            name="tangibility"
            value="digital"
            checked={formState.tangibility === "digital"}
            onChange={(e) => selectTangibilityDispatch(e.target.value)}
          />
